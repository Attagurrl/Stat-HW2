...
hist(sample, col='light grey', border='grey', xlab = '')
```
...
cdf= integrate(fx, lower = 0, upper = 2)
curve(fx, 0, 2, 1000)

#Mean of X, 
#It is clear from the plot above that the curve is symmetric around x=1 and hence the mean should be 1.

fx1= function(x){
  1.5*x*(x-1)^2
}
m= integrate(fx1, lower= 0, upper= 2)
m$value
